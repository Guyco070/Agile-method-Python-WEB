...
class Test(SimpleTestCase):
    ...
    def test_Update_TaskStatus(self):
        ...
        is_status_inserted = "TODO" == SV.find_one({"ProjectName": "Test_project", "USERSTORY": "testUSERSTORY"})[
            "status"]
    ...
    def test_Update_TaskStatus_INPROGRESS(self):
        ...
        is_status_inserted = "INPROGRESS" == SV.find_one({"ProjectName": "Test_project", "USERSTORY": "testUSERSTORY"})[
            "status"]
        client.close()
        self.assertTrue(is_status_inserted)
    ...
    def test_Update_TaskStatus_INTEST(self):
        ...
        is_status_inserted = "INTEST" == SV.find_one({"ProjectName": "Test_project", "USERSTORY": "testUSERSTORY"})[
            "status"]
        client.close()
        self.assertTrue(is_status_inserted)
    ...
    def test_Update_TaskStatus_DONE(self):
        ...
        is_status_inserted = "DONE" == SV.find_one({"ProjectName": "Test_project", "USERSTORY": "testUSERSTORY"})[
            "status"]
        client.close()
        self.assertTrue(is_status_inserted)
